...
<body>
    ...
    <div class="main-content">
        ...
        <div id="products" class="section">
            ...
            <div class="card">
                <div class="card-body">
                    <input type="text" id="prod-search" class="search-input" placeholder="🔍 Rechercher par nom, référence, barcode...">
        ...
        <div id="pdv" class="section">
            ...
            <div class="card">
                <div class="card-body">
                    <input type="text" id="pdv-search" class="search-input" placeholder="🔍 Rechercher un produit par nom ou référence..." oninput="renderPdv()">
    ...
    <script>
        ...
        const supabaseUrl = "https://djnaayhhntopupixzitm.supabase.co";
            const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRqbmFheWhobnRvcHVwaXh6aXRtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA5NzY0NTIsImV4cCI6MjA3NjU1MjQ1Mn0.AzrxJ7h7SNEgn-i8qgdGYPvoEpWdRohX1E8N_Ko_Gc0";
        ...
        function renderDash() {
            ...
            document.getElementById('dash-content').innerHTML = `
                ...
                <div class="card">
                    <div class="card-header"><h3 class="card-title">🚨 Alertes Stock (< 10 unités)</h3></div>
                    <div class="table-container">
                        <table>
                            <thead><tr><th>Produit</th><th>Référence</th><th>Stock</th></tr></thead>
        ...
        function addMovement(e) {
            ...
            alert(`✅ Mouvement enregistré ! Stock ${pdv.name}: ${product.pdvStock[pdvId]}`);
        }
        ...
        function renderPdv() {
            ...
            // Créer l'en-tête avec une colonne par PDV
            thead.innerHTML = `
                <tr>
                    <th>Produit</th>
                    <th>Référence</th>
                    <th>QTY Total</th>
                    ${pdvs.map(pdv => `<th style="color:#667eea;">🏪 ${pdv.name}</th>`).join('')}
                </tr>
            `;
        ...
        function renderHistTable(list) {
            ...
            return list.map(m => {
                const ic = m.type === 'in' ? '➕' : m.type === 'transfer' ? '🔄' : '➖';
                const cl = m.type === 'in' ? '#10b981' : m.type === 'transfer' ? '#f59e0b' : '#ef4444';
                const tp = m.type === 'in' ? 'Entrée' : m.type === 'transfer' ? 'Transfert' : 'Sortie';
                const detail = m.type === 'transfer' ? `${m.from} → ${m.to}` : (m.pdv || '-') + ' / ' + (m.payment || '-');
                return `<tr>
